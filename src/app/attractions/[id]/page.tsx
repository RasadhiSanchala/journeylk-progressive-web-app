    ...
    return (
      <div className="grid min-h-screen place-items-center px-5 text-center">
        <div>
          ...
          <Link href="/" className="mt-4 inline-flex min-h-12 items-center rounded-full bg-blue-700 px-6 font-bold text-white">
            Back to Discover
          </Link>
        </div>
      </div>
    ...
    <div className="bg-slate-50">
      ...
      <section className="relative -mt-10 rounded-t-[2rem] bg-slate-50 px-5 pb-8 pt-7">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <span className="rounded-lg bg-emerald-700 px-3 py-2 text-xs font-black uppercase text-white">{attraction.category}</span>
          <span className="rounded-lg bg-emerald-100 px-3 py-2 text-xs font-bold text-emerald-800">{attraction.openingHours}</span>
        </div>
        ...
        <section className="mt-8">
          ...
          <p className="mt-4 text-base leading-8 text-slate-600">{attraction.description}</p>
        </section>
        ...
        <section className="mt-8">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="grid min-h-24 place-items-center rounded-2xl border border-slate-200 bg-white p-3 text-center shadow-sm">
        ...
        <section className="mt-8">
          <h2 className="text-2xl font-black text-slate-950">Visitor Tips</h2>
          <div className="mt-4 space-y-3">
            {attraction.tips.map((tip) => (
              <div key={tip} className="flex gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
